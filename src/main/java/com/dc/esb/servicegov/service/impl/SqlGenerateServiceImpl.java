 ...
 */
@Component
public class SqlGenerateServiceImpl {

    private Log log = LogFactory.getLog(SqlGenerateServiceImpl.class);
    ...
    private static String path = SqlGenerateServiceImpl.class.getResource("/").getPath() + "/sqlgenerator" + new Date().getTime();
